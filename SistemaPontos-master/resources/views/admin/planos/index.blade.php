...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="box-footer">
            <a href="planos/novo" class="btn btn-default pull-right"> <i class="fas fa-plus"> </i> Adicionar </a>
        </div>
...
$(function() {
    var table = $('#table').DataTable({
        ...
        select: { style: 'multi' },
        processing: true,
        ajax: '/admin/planos/tbl-json',
        columns: [
            { data: 'name', name: 'name' },
            { data: 'points', name: 'points' },
            { data: 'has_adesion', name: 'has_adesion' },
        ...
        { "targets": 2, "render": function (data, type, row) {
            ...
            has_adesion = row.with_adesions[0];

            return has_adesion.name;
        }},
        { "targets": 4, "render": function (data, type, row) {

            html = "<a href='planos/"+row.id+"/editar' class='btn btn-default btn-xs btn-delete'> <i class='fas fa-edit'></i> </a> <button class='btn btn-danger btn-xs btn-delete' onclick=deletar("+row.id+")><i class='fa fa-trash'></i></button> </li>";
            return html;
        }
        }],
        'language': {
